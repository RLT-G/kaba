...
class setting_notificationModel(models.Model):
    ...
    TYPE_NOTIFICATION_CHOICES = (
        ...
        ('ad_company', 'Рекламная кампания'),
        ('ad_site', 'Подключенный сайт'),
        ('finance', 'Финансы'),
        ('access', 'Доступ'),
    ...
    social_network = models.ForeignKey(social_networkModel, related_name='ad_advertiser_setting_notificationModel_social_networkModel', on_delete=models.CASCADE, blank=False, null=True)
