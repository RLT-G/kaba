...
from ad_network.models.profile.setting_notification import setting_notificationModel
...
class notificationModel(models.Model):
    ...
    social_network = models.ForeignKey(social_networkModel, related_name='ad_network_notificationModel_social_networkModel', on_delete=models.CASCADE, blank=False, null=True)
    ...
    def __str__(self):
        return str(self.pk) +', '+ self.type_notification +', '+ self.text_notification
